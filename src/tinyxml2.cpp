...
/* This file has been altered from the original as follows:

   (1) The addition of this comment
   (2) CR line endings have been replaced with LF
   (3) Remove all usage of printf, stderr, stdout to suppress R CMD check warnings
